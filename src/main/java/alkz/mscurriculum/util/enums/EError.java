...
public enum EError implements GenericEnum<String> {
  ...
  PROFESSIONAL_DETAIL_FOUND     ("0016", "This user already has professional details."),
  PROFESSIONAL_DETAIL_NOT_FOUND ("0017", "Professional details not found for this user."),
  ...
  EXPERIENCE_NOT_FOUND          ("0021", "Professional experience not found for this professional detail."),
